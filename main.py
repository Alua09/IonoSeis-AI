...
with tab4:
    ...
    st.info(
        "💡 **Вывод:** Система не просто «видит» данные, она использует статистический фильтр, чтобы отсеять хаотичный шум и оставить только значимые геофизические сигналы.")