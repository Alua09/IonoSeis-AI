...
st.markdown("""
    ...
    .stExpander { border-color: #333 !important; background-color: #161a27 !important; }
    </style>
...
with tab3:
    st.subheader("Карта регионов мониторинга")
...
with tab4:
    ...
    st.markdown("Наша система работает на базе теории **литосферно-ионосферного взаимодействия (LIS)**.")
